...
import net.sattes.runetech_theory.item.custom.*;
import net.sattes.runetech_theory.item.custom.gear.trinkets.*;
import net.sattes.runetech_theory.item.custom.runewords.RunewordFoxItem;
import net.sattes.runetech_theory.item.custom.weapons.*;
...
public class ModItems {
    ...
    public static final Item TEST_SPAWN_EGG = registerItem("test_spawn_egg",
            new SpawnEggItem(ModEntities.TEST, 0x948e3d, 0x3b3635,
                    new FabricItemSettings().group(ModItemGroups.COOLSTUFF).rarity(Rarity.COMMON)) );
    ...
    public static Item registerItem(String name, Item item) {
        return Registry.register(Registry.ITEM, new Identifier(RunetechTheory.MOD_ID, name), item);
    }

    public static void registerModItem() {
        System.out.println("Registering Mod Items for " + RunetechTheory.MOD_ID);
    }
}
